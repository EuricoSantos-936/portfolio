          ...
          <Row className="abouttextbackground">
            ...
            <Col md={5}>
              ...
              <p className="abouttext">
                I'm a self-taught Web developer from Portugal. I'm looking to
                apply on any project, alone or on team, to learn and upgrade my
                skill, always offering the best service to the client.
              </p>
              <br />
              <br />
              ...
              <ul className="skillstext">
                <Row>
                  ...
                  <Col md={6}>
                    ...
                    <li>
                      <BiLogoReact /> React-Bootstrap
                    </li>
                    <li>
                      <BiLogoGithub /> Git/Github
                    </li>
                    <li>
                      <DiPhotoshop /> Design with Photoshop
                    </li>
                  </Col>
                </Row>
              </ul>
